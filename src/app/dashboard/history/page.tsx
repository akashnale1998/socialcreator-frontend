...
import { History, Search, Download, Trash2, Zap, Type, FileSearch, Lightbulb, Copy, CheckCircle2, Brain } from 'lucide-react';
...
export default function HistoryPage() {
  ...
  const handleCopy = (item: any) => {
    ...
    } else if (item.type === 'profile_analysis') {
  ...
  const getIcon = (type: string) => {
    switch (type) {
      ...
      case 'profile_analysis': return Brain;
      default: return Zap;
    }
  };
  ...
  const getIconColor = (type: string) => {
    switch (type) {
      ...
      case 'profile_analysis': return "text-primary";

...
import { Type, Copy, Bookmark, RefreshCw, BarChart2, AlertCircle, ArrowRight } from 'lucide-react';
import { useDispatch, useSelector } from 'react-redux';
import { RootState, AppDispatch } from '@/store/store';
import { generateTitleThunk } from '@/store/apis';
          ...
          <AnimatePresence>
            {error && (
              <motion.div 
                ...
                className="p-4 bg-rose-500/10 border border-rose-500/20 rounded-xl space-y-3 overflow-hidden"
              >
                ...
                <Link href="/dashboard/plans" className="block">
                  <Button variant="outline" size="sm" className="w-full border-rose-500/20 text-rose-500 hover:bg-rose-500/20 font-bold">
                    Upgrade Now <ArrowRight size={14} className="ml-2" />
                  </Button>
                </Link>
              </motion.div>
            )}
